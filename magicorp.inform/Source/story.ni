...
Conference Room is a room. "The room ment to be your next step in the Magicorp lader, now strewn with the bodies of the dead board members with only one living witness in the corner. You will need to find out exactly what happened. Maybe ask the witness about the murderrs?"
...
Dark Arts Inc is a room. Dark Arts Inc is north of Void Portal. ""
...
[spell to unlock final door: from documentation 6.13]
...
Check casting portasum openab:
	...
	if the player has Spell Note, say "In a clap of thunder and a bright flash, a glowing portal appears to the north."
	
[action of what happens]
Carry out casting portasum openab:
	move Void Portal to north of Closet and south of Dark Arts Inc.]
	
[Instead of doing anything to Void Portal:
     If the player is not carrying Spell Note say "You can't do that.";
     Otherwise say "In a clap of thunder and a bright flash, a glowing portal appears to the north.".]
	
[Instead of going north of Closet when player is not carrying Spell Note:
	say "There is no where to go."

Spell Note is a thing. Spell Note is in Conference Room. the description is "a note with a low level portal spell that even you could "
...
"murders"	"I was behind a board member as it happened, but I saw that a figure clad in black rushed in and started casting spells of black magic to kill every one. Oh I can't even try to describe how they died
]
